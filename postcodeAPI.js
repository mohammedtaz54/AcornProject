...
function CraftyPostcodeClass () {
	this.config = {
		...
		access_token	: 'ef997-4596c-2db37-0260a', // specify access token here to use the direct JS method,  lookup_url must be set to 'http://pcls1.craftyclicks.co.uk/lookup_js.php'
